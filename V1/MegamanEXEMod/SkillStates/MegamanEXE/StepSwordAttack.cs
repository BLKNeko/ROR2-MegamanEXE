...
{
    public class StepSwordAttack : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            this.earlyExitDuration = StepSwordAttack.baseEarlyExit / this.attackSpeedStat;
            this.hasFired = false;
            ...
            PlayAnimation("FullBody, Override", "StepSwordAttack", "attackSpeed", this.duration);
            ...
            float dmg = StepSwordAttack.damageCoefficient;
            ...
            this.attack.hitEffectPrefab = StepSwordAttack.hitEffectPrefab;
        ...
        public void FireAttack()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    base.AddRecoil(-1f * StepSwordAttack.attackRecoil, -2f * StepSwordAttack.attackRecoil, -0.5f * StepSwordAttack.attackRecoil, 0.5f * StepSwordAttack.attackRecoil);
                    ...
                    if (this.attack.Fire())
                    {
                        ...
                        if (!this.hasHopped)
                        {
                            ...
                            {
                                base.SmallHop(base.characterMotor, StepSwordAttack.hitHopVelocity);
                            }
