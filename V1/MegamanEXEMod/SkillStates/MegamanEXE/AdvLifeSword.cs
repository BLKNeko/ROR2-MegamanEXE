...
{
    public class AdvLifeSword : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            this.earlyExitDuration = AdvLifeSword.baseEarlyExit / this.attackSpeedStat;
            this.hasFired = false;
            ...
            float dmg = AdvLifeSword.damageCoefficient;
            ...
            this.attack.hitEffectPrefab = AdvLifeSword.hitEffectPrefab;
        ...
        public void FireAttack()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    base.AddRecoil(-1f * AdvLifeSword.attackRecoil, -2f * AdvLifeSword.attackRecoil, -0.5f * AdvLifeSword.attackRecoil, 0.5f * AdvLifeSword.attackRecoil);
                    ...
                    if (this.attack.Fire())
                    {
                        ...
                        if (!this.hasHopped)
                        {
                            ...
                            {
                                base.SmallHop(base.characterMotor, AdvLifeSword.hitHopVelocity);
                            }
