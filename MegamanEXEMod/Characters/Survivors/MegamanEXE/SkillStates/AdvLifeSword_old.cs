...
{
    public class AdvLifeSword_old : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            this.earlyExitDuration = AdvLifeSword_old.baseEarlyExit / this.attackSpeedStat;
            this.hasFired = false;
            ...
            float dmg = AdvLifeSword_old.damageCoefficient;
            ...
            this.attack.hitEffectPrefab = AdvLifeSword_old.hitEffectPrefab;
        ...
        public void FireAttack()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    base.AddRecoil(-1f * AdvLifeSword_old.attackRecoil, -2f * AdvLifeSword_old.attackRecoil, -0.5f * AdvLifeSword_old.attackRecoil, 0.5f * AdvLifeSword_old.attackRecoil);
                    ...
                    if (this.attack.Fire())
                    {
                        ...
                        if (!this.hasHopped)
                        {
                            ...
                            {
                                base.SmallHop(base.characterMotor, AdvLifeSword_old.hitHopVelocity);
                            }
