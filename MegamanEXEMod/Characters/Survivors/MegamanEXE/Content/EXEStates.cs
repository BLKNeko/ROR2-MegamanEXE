...
namespace MegamanEXEMod.Survivors.MegamanEXE
{
    public static class EXEStates
    {
        public static void Init()
        {
            ...
            Modules.Content.AddEntityState(typeof(Attack20));
            ...
            Modules.Content.AddEntityState(typeof(DrkPlus77));
            ...
            Modules.Content.AddEntityState(typeof(GutsPnchShot));
            ...
            Modules.Content.AddEntityState(typeof(Spreader));
