...
namespace MegamanEXEMod.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => MegamanEXEPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => MegamanEXEPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_UNLOCKABLE_REWARD_ID";
